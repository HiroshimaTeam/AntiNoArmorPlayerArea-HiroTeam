...
---
### How to use
[ENG] Configure in config.yml the message. Don't forget install WorldGuard in your Serveur. Make a area with WorldGuard and after you can add/remove/see_list AntiNoStuff area with the command /antinostuff <[add|remove|list]> <WorldGuard area name> </br>
